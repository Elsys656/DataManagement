...
namespace DataManagement
{
    ...
    partial void InsertProductUPC(ProductUPC instance);
    partial void UpdateProductUPC(ProductUPC instance);
    partial void DeleteProductUPC(ProductUPC instance);
    ...
    partial void DeleteProductInventory(ProductInventory instance);
		...
		public DataClasses1DataContext() : 
				base(global::DataManagement.Properties.Settings.Default.AdventureWorks2017ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<ProductUPC> ProductUPCs
		{
			get
			{
				return this.GetTable<ProductUPC>();
			}
		}
		
		public System.Data.Linq.Table<vProductAndDescription> vProductAndDescriptions
		{
			get
			{
				return this.GetTable<vProductAndDescription>();
			}
		}
	...
	public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<ProductUPC> _ProductUPCs;
    ...
    partial void OnModifiedDateChanged();
		...
		public Product()
		{
			this._ProductUPCs = default(EntityRef<ProductUPC>);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_ProductUPC", Storage="_ProductUPCs", ThisKey="ProductID", OtherKey="ProductID", IsUnique=true, IsForeignKey=false)]
		public ProductUPC ProductUPCs
		{
			get
			{
				return this._ProductUPCs.Entity;
			}
			set
			{
				ProductUPC previousValue = this._ProductUPCs.Entity;
				if (((previousValue != value) 
							|| (this._ProductUPCs.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._ProductUPCs.Entity = null;
						previousValue.Product = null;
					}
					this._ProductUPCs.Entity = value;
					if ((value != null))
					{
						value.Product = this;
					}
					this.SendPropertyChanged("ProductUPCs");
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="Production.ProductUPC")]
	public partial class ProductUPC : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _UpcAType;
		
		private System.Nullable<int> _UpcACompany;
		
		private System.Nullable<int> _UpcID;
		
		private System.Data.Linq.Binary _UpcImage;
    ...
    partial void OnProductIDChanging(int value);
    partial void OnProductIDChanged();
    partial void OnUpcATypeChanging(System.Nullable<int> value);
    partial void OnUpcATypeChanged();
    partial void OnUpcACompanyChanging(System.Nullable<int> value);
    partial void OnUpcACompanyChanged();
    partial void OnUpcIDChanging(System.Nullable<int> value);
    partial void OnUpcIDChanged();
    partial void OnUpcImageChanging(System.Data.Linq.Binary value);
    partial void OnUpcImageChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="Id", Storage="_Id", AutoSync=AutoSync.Always, DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int ProductID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UpcAType", DbType="Int")]
		public System.Nullable<int> UpcAType
		{
			get
			{
				return this._UpcAType;
			}
			set
			{
				if ((this._UpcAType != value))
				{
					this.OnUpcATypeChanging(value);
					this.SendPropertyChanging();
					this._UpcAType = value;
					this.SendPropertyChanged("UpcAType");
					this.OnUpcATypeChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UpcACompany", DbType="Int")]
		public System.Nullable<int> UpcACompany
		{
			get
			{
				return this._UpcACompany;
			}
			set
			{
				if ((this._UpcACompany != value))
				{
					this.OnUpcACompanyChanging(value);
					this.SendPropertyChanging();
					this._UpcACompany = value;
					this.SendPropertyChanged("UpcACompany");
					this.OnUpcACompanyChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UpcID", DbType="Int")]
		public System.Nullable<int> UpcID
		{
			get
			{
				return this._UpcID;
			...
			set
			{
				if ((this._UpcID != value))
				{
					this.OnUpcIDChanging(value);
					this.SendPropertyChanging();
					this._UpcID = value;
					this.SendPropertyChanged("UpcID");
					this.OnUpcIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_UpcImage", DbType="VarBinary(MAX)", UpdateCheck=UpdateCheck.Never)]
		public System.Data.Linq.Binary UpcImage
		{
			get
			{
				return this._UpcImage;
			}
			set
			{
				if ((this._UpcImage != value))
				{
					this.OnUpcImageChanging(value);
					this.SendPropertyChanging();
					this._UpcImage = value;
					this.SendPropertyChanged("UpcImage");
					this.OnUpcImageChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_ProductUPC", Storage="_Product", ThisKey="ProductID", OtherKey="ProductID", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Product.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.ProductUPCs = null;
					}
					this._Product.Entity = value;
					if ((value != null))
					{
						value.ProductUPCs = this;
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="Production.vProductAndDescription")]
	public partial class vProductAndDescription
	{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ProductModel", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CultureID", DbType="NChar(6) NOT NULL", CanBeNull=false)]
